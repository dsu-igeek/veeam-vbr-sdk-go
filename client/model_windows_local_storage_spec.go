...
func NewWindowsLocalStorageSpec(hostId string, repository WindowsLocalRepositorySettingsModel, mountServer MountServerSettingsModel, share SmbRepositoryShareSettingsModel) *WindowsLocalStorageSpec {
