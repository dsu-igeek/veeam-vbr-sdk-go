...
func NewNfsStorageSpec(share NfsRepositoryShareSettingsModel, repository NetworkRepositorySettingsModel, mountServer MountServerSettingsModel, hostId string) *NfsStorageSpec {
	this := NfsStorageSpec{}
	this.HostId = hostId
