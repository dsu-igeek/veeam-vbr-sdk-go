...
func NewSmbStorageSpec(share SmbRepositoryShareSettingsModel, repository NetworkRepositorySettingsModel, mountServer MountServerSettingsModel, hostId string) *SmbStorageSpec {
	this := SmbStorageSpec{}
	this.HostId = hostId
